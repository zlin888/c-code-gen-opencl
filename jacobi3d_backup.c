...
int main(void) {
  ...
  //launch_kernel("jacobi3d_opt1_update.cl", 128, 4, 3); // this one actually update the rolling windows in every iteration
  ////launch_kernel("jacobi3d_opt0.cl", 128, 4, 3);
  ////launch_kernel("jacobi3d_opt1.cl", 128, 4, 3);
  ////launch_kernel("jacobi3d_opt2.cl", 128, 4, 3);
  ////launch_kernel("jacobi3d_opt3.cl", 128, 4, 3); // this one has a very good opt but not rolling windows
  //launch_kernel("seidel3d.cl", 128, 4, 3); 
  //launch_kernel("seidel3d_opt1_update.cl", 128, 4, 3); 

  //launch_kernel("seidel3d27.cl", 128, 4, 3); 
  //launch_kernel("seidel3d27_opt1_update.cl", 128, 4, 3); 

  launch_kernel("jacobi3d7pt_opencl.h", 128, 4, 3);
  launch_kernel("rolling_jacobi3d7pt_opencl.h", 128, 4, 2);

  launch_kernel("jacobi3d15pt_opencl.h", 128, 4, 3);
  launch_kernel("rolling_jacobi3d15pt_opencl.h", 128, 4, 2);

  launch_kernel("jacobi3d27pt_opencl.h", 128, 4, 3);
  launch_kernel("rolling_jacobi3d27pt_opencl.h", 128, 4, 2);
  return 0;
}
