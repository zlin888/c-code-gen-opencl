...
__kernel void cl_kernel(__global float * p_set, __global float * p_res) {
    ...
    if(pos_x > 0 && pos_x < N-1 && pos_y > 0 && pos_y < N - 1 && pos_z > 0 && pos_z < N -1){
    	res[pos_x][pos_y][pos_z] = (
                                    set[pos_x][pos_y][pos_z] + set[pos_x][pos_y][pos_z+1] + set[pos_x][pos_y][pos_z-1]
                                  + set[pos_x][pos_y-1][pos_z] + set[pos_x][pos_y-1][pos_z+1] + set[pos_x][pos_y-1][pos_z-1]
                                  + set[pos_x][pos_y+1][pos_z] + set[pos_x][pos_y+1][pos_z+1] + set[pos_x][pos_y+1][pos_z-1]
                                  
                                  + set[pos_x+1][pos_y][pos_z] + set[pos_x+1][pos_y][pos_z+1] + set[pos_x+1][pos_y][pos_z-1]
                                  + set[pos_x+1][pos_y-1][pos_z] + set[pos_x+1][pos_y-1][pos_z+1] + set[pos_x+1][pos_y-1][pos_z-1] 
                                  + set[pos_x+1][pos_y+1][pos_z] + set[pos_x+1][pos_y+1][pos_z+1] + set[pos_x+1][pos_y+1][pos_z-1]
